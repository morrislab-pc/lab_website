...
27. Once all electrodes are green, remove the needle tips from your syringe and put them in the dirty bucket (bottom rack of the supply cart). If your syringe still has gel, put the red stopper back on. Otherwise, put the syringe in the dirty bowl as well to be cleaned later.
...
29. Bring up your BrainVision Recorder window. Click on the eye icon then on the green start button to begin recording. Name your file according to lab conventions (with participant number!) and choose where to save your file. The lexical decision task eeg file should be nammes M21_S###\_ldt_eeg:
...
37. Immediately start a new brainvision recording for the visual statistical learning task. Name your file: m21_S###\_vsl_eeg. Do not append the new file to the old one.
...
42. Retreat to the control room. For this portion of the experiment, the participant will see a series of shapes flash across the screen for 10 minutes. After this phase, they will see a screen that prompts the experimenter to press the left control button to continue the experiment. At this point, please stop the BrainVision recording and start a new one with the VSL2 label. Then, instruct the participant to press the left control button. They will be presented with a series of triplets where they will need to select which seems more familiar. Once they complete the activity, stop the EEG recording. Go into the experimental room and click 'finish' to save their data:
...
45. Disburse money to the participant for their efforts. Make sure to fill out the HPL DISBURSEMENT LOG and have the participant sign that they received the money. Each participant will be paid \$20- \$25 for their participation.
