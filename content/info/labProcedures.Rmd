...
39. This should open the file in Presentation. Click "Run" and then enter the Subject ID when prompted. Make sure to enter **the full experiment file name**: M21_s###\_VSL1_BEH.
...
8.  Upload the following files from the control computer:
    ...
    -   m21_Sxxx_VSL1_EEG.eeg
    -   m21_Sxxx_VSL1_EEG.vhdr
    -   m21_Sxxx_VSL1_EEG.vmrk
    -   m21_Sxxx_VSL2_EEG.eeg
    -   m21_Sxxx_VSL2_EEG.vhdr
    -   m21_Sxxx_VSL2_EEG.vmrk

9.  Altogether, you should upload 12 files to your participant folder.
